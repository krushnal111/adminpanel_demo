...
/******************* 
@Purpose : Used for static bolg
@Parameter : props
@Author : INIC
******************/
function EachStatic(props) {
            ...
            <div className="blog-page">
              <div className="back-btn d-flex align-items-center mb-3">
                <Link
                  className=""
                  onClick={() => {
                    props.history.push(`/editStatic/${blogStaticId}`);
                  }}
                >
                  <em className="bx bx-chevron-left mr-1"></em>
                  <span>Back</span>
                </Link>
              </div>
...
@Author : INIC
******************/
export default connect(mapStateToProps, { callApi })(EachStatic);
